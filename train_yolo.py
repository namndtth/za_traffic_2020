...
def get_dataset(dataset, args):
    ...
    train_items = items[indices][:train_size]
    train_labels = labels[indices][:train_size]
    val_items = items[indices][train_size:]
    val_labels = labels[indices][train_size:]

    train_dataset = ts.TrafficSigns(train_items, train_labels)
    val_dataset = ts.TrafficSigns(val_items, val_labels)
